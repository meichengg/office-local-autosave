...
- Đổi mặc định autosave an toàn: `IntervalSeconds=1`, `MinIdleSeconds=3`, `ForegroundMinIdleSeconds=1`.
- Thêm xoay vòng log mặc định `LogMaxKB=1024`, `LogKeepCount=3` để `autosave.log` không phình vô hạn.
